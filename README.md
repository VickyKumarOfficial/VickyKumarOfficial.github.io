...
<td align="center" width="25%">
<img src="https://www.vectorlogo.zone/logos/google_cloud/google_cloud-icon.svg" width="48" height="48" alt="OpenRouter" />
<br><strong>OpenRouter</strong>
...
# AI model calls are backend-only (OpenRouter); no frontend AI key required
```
